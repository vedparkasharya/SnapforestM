...
const RoomSchema = new Schema<IRoom>(
  {
    ...
    category: {
      ...
      enum: ["podcast", "youtube", "music", "photography", "dance", "coworking", "gaming", "streaming", "meeting"],
    },
