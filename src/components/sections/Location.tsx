    ...
    <section className="bg-[#111111] section-padding">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-5 lg:gap-16">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.15, ease: [0.16, 0.3, 1] }} className="lg:col-span-2">
            ...
            <div className="mb-8 flex flex-wrap gap-2">
              {PILLS.map((pill) => <span key={pill} className="rounded-pill bg-[#2a2a2a] px-4 py-1.5 font-mono text-xs text-white">{pill}</span>)}
            </div>
